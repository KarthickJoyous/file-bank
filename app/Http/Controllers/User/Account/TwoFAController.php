    ...
    */
    public function __invoke(Request $request): JsonResponse {
        ...
        try {
            ...
            throw_if(!auth('web')->user()->update([
                'tfa_status' => $tfa_status,
                'tfa_verified' => $tfa_status
            ]),
                new Exception(__('messages.user.profile.tfa_status_updation_failed'))
            );
            ...
            $response = [
                ...
                'message' => __('messages.user.profile.tfa_status_updated', ['status' => $formatted_status])
            ];
